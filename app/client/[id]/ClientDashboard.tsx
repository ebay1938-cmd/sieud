  ...
  return (
    <div className="min-h-screen bg-slate-100 p-6 md:p-10">
      <div className="max-w-[1400px] mx-auto space-y-10">
        ...
        {/* ===== GŁÓWNY PANEL (ZAMIAST STAREJ KARTY OCENY) ===== */}
        <section className="bg-white rounded-2xl p-6 shadow-sm max-w-md space-y-6">
              ...
              <div className="space-y-2">
                {note.snapshot.map((item, i) => (
                  ...
                  >
                    ...
                    <TrendBadge diff={item.change} pct={null} />
                  </div>
                ))}
              </div>
            ) : (
